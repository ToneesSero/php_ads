(function () {
    ...
    if (!listingsContainer || typeof window.renderListingCard !== 'function') {
        return;
    }
    ...
    const handleResponse = (payload) => {
        ...
        state.hasMore = Boolean(paginationData.hasMore);
        state.nextPage = paginationData.nextPage ? Number(paginationData.nextPage) : null;
